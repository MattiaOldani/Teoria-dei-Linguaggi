...
Toccata e fuga nel campo dei *linguaggi context-sensitive*, visto che li vedremo solo qua lol.
...
#figure(image("assets/22_LBA.svg", width: 75%))
...
Riprendiamo gli esempi di prima nei quali abbiamo costruito dei 2DPDA.
