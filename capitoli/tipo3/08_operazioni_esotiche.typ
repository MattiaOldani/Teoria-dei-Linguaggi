...
In questo capitolo andiamo a vedere alcune *operazioni avanzate*.
...
#example()[
  ...
  #figure(image("assets/08_reversal.svg"))
...
#example()[
  ...
  #figure(image("assets/08_esempio_matrice.svg"))
...
#example()[
  ...
  #figure(image("assets/08_matrice_NFA.svg"))
