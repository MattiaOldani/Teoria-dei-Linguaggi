...
I *problemi di decisione* sono dei problemi che hanno come unica risposta *SI* oppure *NO*. Sui linguaggi regolari abbiamo una serie di problemi di decisione interessanti che possono essere risolti in maniera automatica. Questa lista di problemi diventerà ancora più estesa (ma diludente) quando andremo nei linguaggi context-free.
...
Una banale evoluzione del problema di inclusione è quello di *uguaglianza*, ovvero quello che si chiede se $L_1 = L_2$. Per risolvere questo problema basta dimostrare la doppia inclusione $ L_1 subset.eq L_2 and L_2 subset.eq L_1 $ e siamo a cavallo. Un algoritmo diverso utilizza le classi di equivalenza, ma non lo vedremo.
