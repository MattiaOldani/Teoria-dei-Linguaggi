...
#example()[
  Vediamo un automa non deterministico per il linguaggio dell'ultimo esempio del capitolo precedente.

  #figure(image("assets/02_terzultimo_a_nd.svg"))
...
Gli *automi non deterministici*, o *NFA*, sono definiti dalla quintupla $ A = (Q, Sigma, delta, q_0, F) $ che differisce da quella dei DFA solo nella *funzione di transizione*. Essa è la funzione $ delta : Q times Sigma arrow.long 2^Q $ che, dati lo stato corrente e il carattere letto dalla testina, mi manda in un insieme di stati possibili.
...
#example()[
  Considerando l'automa precedente, scriviamo l'albero di computazione che viene generato dall'automa mentre cerca di riconoscere la stringa $x = a b a b a$.
...
L'ultima forma di non determinismo che abbiamo è quella delle $epsilon$-*produzioni*: esse sono transizioni di stato etichettate dalla $epsilon$ che permettono di spostarsi da uno stato all'altro senza leggere un carattere della stringa da riconoscere.
...
#example()[
  ...
  #figure(image("assets/02_segno.svg"))
...
#example()[
  ...
  #figure(image("assets/02_segno_no_epsilon.svg"))
  ...
  #figure(image("assets/02_segno_no_epsilon_sim.svg"))
]
...
#example()[
  ...
  #grid(
    ...
    align: center + horizon,
    inset: 10pt,
    [#figure(image("assets/02_sequenza_a.svg"))],
    [#figure(image("assets/02_sequenza_b.svg"))],
    [#figure(image("assets/02_sequenza_c.svg"))],
  )
  ...
  #figure(image("assets/02_sequenza_arbitrarie.svg"))
  ...
  #figure(image("assets/02_sequenza_arbitrarie_DFA.svg"))
...
#example()[
  ...
  #figure(image("assets/02_ln_epsilon.svg"))
